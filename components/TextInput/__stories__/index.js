...
var textInputRequired = function textInputRequired(e) {
  return (0, _addonActions.action)('TextInput required')(e.target.required);
};
var textInputValue = function textInputValue(e) {
  return (0, _addonActions.action)('TextInput Value')(e.target.value);
};
...
(0, _react3.storiesOf)('TextInput', module).add('Is empty by default', function () {
  ...
  return _react2.default.createElement(_index2.default, { defaultValue: 'Default Value!', handleOnChange: textInputValue });
}).add('Required Text input', function () {
  return _react2.default.createElement(_index2.default, { defaultValue: 'Required text input', required: true, handleOnChange: textInputRequired });
}).add('Disabled Text input', function () {
  return _react2.default.createElement(_index2.default, { defaultValue: 'Disabled text input', disabled: true, handleOnChange: (0, _addonActions.action)('onChange triggered') });
