...
var activePage = { type: 'main', label: 'workplace', url: '/home' };
var subPageActive = { type: 'link', label: 'marketing lists', url: '/communications/marketinglists' };
...
}).add('With a sub-item selected', function () {
  return _react2.default.createElement(_index2.default, { data: _navigationItems2.default, activePage: subPageActive, handleOnClose: (0, _addonActions.action)('handleOnClose called') });
});